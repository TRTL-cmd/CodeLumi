...
If you'd like, I can start with step 1 now and patch `src/core/llm/ollama.ts` to implement robust NDJSON/stream parsing. Proceed with that, or prefer I patch the main proxy first for a faster hotfix?
